    ...
    <div>
      <div class="dlabnav">
        <div class="dlabnav-scroll">
          <ul class="metismenu" id="menu">
            <li>
              ...
              <ul aria-expanded="false">
                ...
                <li>
                  <a href="balance-page.html">Customers List</a>
                </li>
                <li>
                  <a href="card-center.html">Add Customer</a>
                </li>
              </ul>
            </li>
            ...
            <li>
              ...
              <ul aria-expanded="false">
                <li>
                  <a href="app-profile.html">Overview</a>
                </li>
                <li>
                  <a href="post-details.html">All Savings</a>
                </li>
              </ul>
            </li>
            <li>
              ...
              <ul aria-expanded="false">
                <li>
                  <a href="chart-flot.html">Overview</a>
                </li>
                <li>
                  <a href="chart-morris.html">New Application</a>
                </li>
                <li>
                  <a href="chart-chartjs.html">Loan Applicants</a>
                </li>
                <li>
                  <a href="chart-chartist.html">Repayments Defaulters</a>
                </li>
              </ul>
            </li>
            <li>
              ...
              <ul aria-expanded="false">
                <li>
                  <a href="ui-accordion.html">Overview</a>
                </li>
                <li>
                  <a href="ui-alert.html">Users</a>
                </li>
                <li>
                  <a href="ui-badge.html">Add New User</a>
                </li>
                <li>
                  <a href="ui-button.html">Groups And Permissions</a>
                </li>
                <li>
                  <a href="ui-modal.html">Add Group And Permission</a>
                </li>
                <li>
                  <a href="ui-button-group.html">Change Password</a>
                </li>
              </ul>
            </li>
            ...
            <li>
              ...
              <ul aria-expanded="false">
                <li>
                  <a href="form-element.html">Loan Durations</a>
                </li>
              </ul>
            </li>
          </ul>
          ...
          <div class="copyright">
            <p class="fs-14">
              <strong>Eagle Vision</strong> © 2023 All Rights Reserved
            </p>
            <p class="fs-14">
              Designed and Developed by <a href="">Techmint Africa</a>
            </p>
          </div>
        </div>
      </div>
